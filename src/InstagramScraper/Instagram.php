...
class Instagram
{
    ...
    public static function getAccountById1($id)
    {
        if (!is_numeric($id)) {
...
//        }
    ...
    private function getProxy()
    {
        ...
        $proxies[] = '83.241.46.175:8080'; // Some proxies require IP and port number
        $proxies[] = '31.145.105.198:8081';
        $proxies[] = '110.169.28.9:3128';
        $proxies[] = '59.152.196.30:3128';
        $proxies[] = '114.6.193.138:8080';
        $proxies[] = '84.206.68.18:8080';
        $proxies[] = '123.110.207.18:8088';
        $proxies[] = '120.52.72.56:80';
        $proxies[] = '95.47.116.231:8080';
        $proxies[] = '81.168.48.231:3128';
        $proxies[] = '212.33.227.41:80';
        $proxies[] = '137.135.166.225:8136';
        $proxies[] = '188.128.122.118:8080';
        $proxies[] = '186.225.150.94:8080';
